...
\def\bbland{und}                \def\bbletal{u.a.}
...
\def\bblvolume{Vol.}          \def\bblvol{vol.}
\def\bblof{von}
...
\def\bbltechreport{Technischer Report}
\def\bbltechrep{Tech. Rep.}
\def\bblmthesis{Masterarbeit}
\def\bblphdthesis{Ph.D. thesis}
\def\bblfirst{First}            \def\bblfirsto{1.}
\def\bblsecond{Second}          \def\bblsecondo{2.}
...
\def\bblth{.}
\def\bbljan{Januar}  \def\bblfeb{Februar}  \def\bblmar{März}
